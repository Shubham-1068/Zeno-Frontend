  ...
  return (
    <div className="min-h-screen bg-[#ffffff] text-white">
      <div className="relative flex h-screen">
        {/* Main Content */}
        <div className="relative flex flex-col h-[88%] w-full mt-20 px-5 md:px-0">
          {/* Video Grid big screen */}
          <div className="hidden flex-1 md:grid grid-cols-1 gap-4 p-2 px-5 h-[90%] w-[100%]">
            <div className="relative rounded-2xl overflow-hidden border-2 border-[#01aac1] h-full flex flex-col justify-center items-center">
              {/* LocalVideo */}
              <div className="absolute bottom-2 right-2 rounded-2xl overflow-hidden border-2 border-[#01aac1] h-[130px] w-[230px] flex flex-col justify-center items-center">
                <video
                  ref={localVideoRef}
                  autoPlay
                  playsInline
                ...
                />
                <div className="absolute bottom-1 right-1 flex items-center gap-2 bg-black px-2 py-1 rounded-lg">
            ...
            >
              <div className="relative h-full w-[60vw] flex px-16 justify-between items-center text-center bg-[#01aac1] text-black">
                ...
                <div className="text-start">
                  ...
                  <h2 className="text-[5vw] font-extrabold text-white">TO</h2>
                  <h2 className="text-[5vw] font-extrabold text-white">ᘔEᑎO</h2>
                </div>
              </div>
